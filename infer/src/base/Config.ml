...
and autogenerated_code_check_mode =
  CLOpt.mk_bool ~long:"autocode-check-mode" ~default:false
    "Enable auto-generated code check mode for Pulse. Need also $(b, --autocode-file) and $(b, --autocode-function)."
...
and autogenerated_code_check_mode = !autogenerated_code_check_mode
