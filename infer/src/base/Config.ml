...
and autogenerated_vendor_check_mode =
  CLOpt.mk_bool ~long:"autocode-vendor-mode" ~default:false
    "Enable auto-generated code check mode for Pulse. Need also $(b, --autocode-function)."

and autogenerated_client_check_mode =
  CLOpt.mk_bool ~long:"autocode-client-mode" ~default:false
    "Enable auto-generated code check mode for Pulse. Need also $(b, --autocode-function)."
...
and autogenerated_client_check_mode = !autogenerated_client_check_mode

and autogenerated_vendor_check_mode = !autogenerated_vendor_check_mode
