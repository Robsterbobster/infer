...
and autogenerated_check_mode =
  CLOpt.mk_bool ~long:"autocode-check-mode" ~default:false
    "Enable auto-generated code check mode for Pulse."

and record_vendor_latent =
  CLOpt.mk_bool ~long:"record-vendor-latent" ~default:false
    "Enable to record vendor latent error."    

and call_stats_mode =
  CLOpt.mk_bool ~long:"call-stats-mode" ~default:false
    "Enable auto-generated code check mode for Pulse."

and record_vendor_info =
  CLOpt.mk_bool ~long:"record-vendor-info" ~default:false
    "Enable to record vendor info. Need with $(b, --autocode-check-mode)"
...
and record_vendor_latent = !record_vendor_latent

and call_stats_mode = !call_stats_mode

and record_vendor_info = !record_vendor_info
