...
val vendor_pre_mode : bool

val autogenerated_code_function : string option

val autogenerated_code_file : string option

val autogenerated_check_mode : bool

val record_vendor_latent : bool

val call_stats_mode : bool

val record_vendor_info : bool
