...
module PulseTransferFunctions = struct
  ...
  let add_blame_to_addr tenv proc_desc location addr astate =
    ...
    PulseOperations.add_blame addr entity astate) else astate in
    astate
              ...
              if Config.pulse_isl then
                ...
                |> List.map ~f:(fun result ->
                       ...
                       let astate = if Config.autogenerated_check_mode then (
                        ...
                        PulseOperations.add_blame rhs_addr entity astate) else astate
                      in
            ...
            let astates =
              List.concat_map ls_astate_lhs_addr_hist ~f:(fun result ->
                  ...
                  let astate = if Config.autogenerated_check_mode then (
                    ...
                    let entity = Entity.Unknown in
                    PulseOperations.add_blame lhs_addr entity astate) else astate
                  in
