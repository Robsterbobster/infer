...
let of_posts tenv proc_desc err_log location posts =
  ...
  if Config.record_vendor_latent && PulseOperations.check_in_vendor_world (Procname.get_method (Procdesc.get_proc_name proc_desc)) then write_summary_and_posts_json summary_labels_list_filtered path;
